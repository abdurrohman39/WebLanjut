...
if(empty($_GET['id_jadwal'])){
  $p="Simpan";
  $query=mysql_query("SELECT * FROM tb_jadwal ORDER BY id_jadwal desc");
  ...
  $p="Edit";
  $query="Edit";
  $nomot=$_GET['id_jadwal'];
}

$tquery=mysql_query("SELECT * from tb_jadwal where id_jadwal='$_GET[id_jadwal]'");
...
<div class="row">
  <div class="col-md-12">
    <form class="form-sample" action="crud/simpan_jadwal.php"  method="POST" enctype="multipart/form-data" name="myForm" onsubmit="return validateForm()">
      <div class="row">
        <div class="col-md-12">
          <input type="hidden" name="id_jadwal" value="<?php echo $nomot; ?>"/>
          <div class="form-group row">
            <label class="col-sm-3 col-form-label">Nama Jadwal</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" name="nama_jadwal" value="<?php echo $tampil[nama_jadwal];?>"/>
            </div>
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" class="form-control" name="tgl_jadwal" value="<?php echo $tampil[tgl_jadwal]; ?>" />
            </div>
          </div>
        </div>
