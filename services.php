...
<body>
    ...
    <div class="teks">
					<p><h1><b><marquee>News - Daerah</marquee></b></h1></p>
						 </div>
    <div>
    <img src="images/unimusbg.jpeg" style="width:100%; height:100%;">
    </div>
    <div class="teks">
					<p><h1><b><u><center>News - Daerah</center></u></b></h1></p>
						 </div>
    
    <?php
        //Data mentah yang ditampilkan ke tabel
        include "koneksi.php";    
       $sql = mysql_query("SELECT * FROM tb_berita where kategori= 'Terlama' ");
       $no = 1;
